#After file '1_Subsetting_sixpopulations', CD4 and CD8 cells were analyzed separatly
...
setwd("/Users/EmiliaSR/Desktop/scRNA/R Stuff/CD8")
getwd()

file_name = "CD8_29012024.RData"
...
save(SO.integrated, file = "CD8_integrated_29012024.RData")
...
CD8_celltypeFAM <- FindAllMarkers(SO.integrated, only.pos = TRUE, 
                              min.pct = 0.25, 
                              logfc.threshold = 0.25)

write.csv(CD8_celltypeFAM, 
          file ="/Users/EmiliaSR/Desktop/scRNA/R stuff/CD8/CD8_FAM_celltype.csv")
